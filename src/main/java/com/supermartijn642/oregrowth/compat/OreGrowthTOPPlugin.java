...
public class OreGrowthTOPPlugin implements Function<ITheOneProbe,Void> {
    ...
    private static class WrappedItemStackElement extends ElementItemStack {
        ...
        public void render(GuiGraphics graphics, int x, int y){
            BakedModel model = ClientUtils.getItemRenderer().getItemModelShaper().getItemModel((this.isComplete ? OreGrowth.COMPLETE_ORE_GROWTH_BLOCK : OreGrowth.ORE_GROWTH_BLOCK).asItem());
